...
class Submission:
    ...
    def execute_student_plan(self, warehouse, box_todo, max_distance, max_steering, return_dict):
        # states = []
            ...
            for action in action_list:
                ...
                if len(delivered) > num_delivered:
                    ...
                    if last_box_delivered == next_box_to_deliver:
                        ...
                        #                 next_box_to_deliver))
                        print 'wrong box delivered: {} instead of {}'.format(last_box_delivered,
                                        next_box_to_deliver)

            if num_delivered != len(box_todo):
                # raise Exception("Did not deliver all boxes. Only delivered: {}".format(num_delivered))
                print "Did not deliver all boxes. Only delivered: {}".format(num_delivered)
...
class State:
    ...
    def update_according_to(self, action):
        ...
        if action_type == 'move':
            ...
            print 'improperly formatted action: {}'.format(''.join(action))
    ...
    def _attempt_move(self, steering, distance):
        ...
        try:
            ...
            print 'improperly formatted move destination: {} {}'.format(steering, distance)
    ...
    def _attempt_lift(self, box_id):
        ...
        try:
            ...
            print 'improper key {}'.format(box_id)
...
class PartBTestCase(unittest.TestCase):
    ...
    def run_with_params(self, params):
        ...
        test_process = mproc.Process(target=self.student_submission.execute_student_plan,
                                     ...
                                     params['todo'],
                                     params['max_distance'],
                                     params['max_steering'], return_dict))
