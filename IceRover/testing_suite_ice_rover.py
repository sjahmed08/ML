...
########################################################################
# set to True for lots-o-output, also passed into robot under testdistance
########################################################################
VERBOSE_FLAG = True
...
class State:
    ...
    def _attempt_sample(self):
        ...
        for sample_location in self.sample_todo:
            ...
            # print "distance between sample location and todo", distance
